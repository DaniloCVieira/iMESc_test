...
observeEvent(input$close_histo,{
  ...
  observeEvent(input$tools_drop9,{
   ...
   output$pct_rareabund<-renderUI({
     div(
       checkboxInput("rareabund","Abund<",F, width='100px'),
       conditionalPanel("input.rareabund==T",{
   ...
   output$pct_rarefreq<-renderUI({
     div(
       checkboxInput("rarefreq","Freq<",F, width='100px'),
       conditionalPanel("input.rarefreq==T",{
   ...
   output$pct_raresing<-renderUI({
     div(
       checkboxInput("raresing","Singletons",F, width='100px'),
