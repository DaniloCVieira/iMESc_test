...
tipify(span('Breakpoints'), "The break points computed", placement = "right")
  ...
  cur_tag_fun<-reactiveValues(df='level order')
  ...
  observeEvent(input$dcogs1,{
    showModal(
      modalDialog(size="m",easyClose = T,footer =NULL,
                  div(
                    span(
                      inline(textInput("dcogs1_rename", div("Rename Datalist",em(input$data_bank, style="color: SeaGreen")),placeholder = "New name", width="200px")),
    ...
    showModal(
      modalDialog(size="m",easyClose = T,footer =NULL,
                  div(
                    ...
                    span(
                      inline(textInput("dfcogs1_rename", div("Rename Factor:",em(inline(uiOutput('dfcogs1_targ')), style="color: SeaGreen")),placeholder = "New name", width="200px")),
